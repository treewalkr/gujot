...
// storage backend. Postgres is the always-available baseline; Redis is an
// optional second impl (#5), selected by REDIS_URL and wrapped so Postgres
// remains the fallback when Redis is unreachable. An in-memory impl ships here
